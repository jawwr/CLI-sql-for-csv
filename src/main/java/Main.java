...
//        interpreter.interpret("INSERT INTO countries VALUES testCountry, testCapital, -10, testPopulation, testContinent");
//        interpreter.interpret("select * from numbers");
//        interpreter.interpret("select * from countries");
        interpreter.interpret("DELETE FROM countries WHERE square < 0");
    }
}